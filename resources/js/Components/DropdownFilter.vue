...
<template>
    <div class="relative" ref="dropdownRef">
        <div
            class="flex cursor-pointer items-center gap-x-2 rounded-md border border-dashed border-zinc-900/20 px-3 py-2 text-zinc-800 hover:bg-zinc-900/5 dark:border-white/20 dark:text-zinc-200 dark:hover:bg-white/5"
            @click="isOpen = !isOpen"
        ...
        >
            ...
            <p class="select-none text-sm font-semibold">{{ label }}</p>
        </div>
            ...
            <div class="p-1" v-if="filteredOptions.length">
                ...
                >
                    <input
                        ...
                        :id="`ch-${opt.value}`"
                        :value="opt.value"
                        class="rounded border-zinc-900/30 bg-transparent dark:border-zinc-100/30"
